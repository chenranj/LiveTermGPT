...
Implemented OpenAI for LiveTerm. **Mobile Friendly**, highly customizable, easy-to-use, and minimal terminal styled website template, powered by Next.js.
...
```javascript
{
  ...
  "openai_sys": "", // Modify your own system prompt to meet your requirement
  "colors": {
    "light": {
      ...
    },
...
* Based on  Cviennt's [LiveTerm](https://github.com/Cveinnt/LiveTerm)
